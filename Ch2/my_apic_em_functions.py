...
def get_ticket():
    ...
    api_url = "https://devnetsbx-netacad-apicem-1.cisco.com/api/v1/ticket"  # change this if using a different APIC-EM sandbox
    ...
    body_json = {
        ...
        "password": "NTgmY5UY"       # change this if using a different APIC-EM sandbox
    }
